...
export default function ProductForm({ params }: { params: Usable<{ id: string }> }) {
  ...
  // Создаем ID для уведомления о загрузке
                  ...
                  <div className="border-2 border-dashed border-primary/50 rounded-lg p-6 text-center hover:border-primary transition-colors">
                    ...
                    <div className="flex justify-center">
                      <UploadButton<OurFileRouter, "productImage">
                        ...
                        onUploadBegin={() => {
                          setUploading(true);
                          // Показываем уведомление с анимированным индикатором загрузки
                          toast({
                            id: uploadToastId,
                            title: "Загрузка изображений",
                            description: (
                              <div className="flex items-center">
                                <div className="mr-2 animate-spin rounded-full h-5 w-5 border-2 border-orange-500 border-t-transparent"></div>
                                <span>Пожалуйста, подождите...</span>
                              </div>
                            ),
                            duration: 100000 // Очень долгое время, будет закрыто программно
                          });
                        }}
